...
@section('content')
    ...
    <div class="col-lg-8">
        <form action="/admin/blogs/{{ $blog->slug }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug"
                    required readonly value="{{ old('slug', $blog->slug) }}">
                <div class="invalid-feedback">
                    @error('slug')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-3">
                ...
                @if ($blog->image)
                    <img src="/img/blog/{{ $blog->image }}" alt="error"
